    ...
    internal class Bloque1
    {
        ...
        static void B1B()
        {
            ...
            while (key == false)
            {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("Tenes justo 18 años.");
                    key = true;
                }
                else if (edad > 18)
                {
        ...
        static void B1E()
        {
            ...
            while (vuelta <= 10)
            {
                Console.WriteLine("Ingrese el número " + vuelta + ":");
                int numero = Convert.ToInt32(Console.ReadLine());
                if (numero > masAlto)
                    masAlto = numero;
                vuelta = vuelta + 1;
            }
            Console.WriteLine("El numero más alto fue: " + masAlto);
        }
